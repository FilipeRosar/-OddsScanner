...
export default function MatchCard({ match }: MatchCardProps) {
  // Busca a melhor odd por seleção
  ...
  const valueHome = calculateValue(bestHome, "Home");
  const valueDraw = calculateValue(bestDraw, "Draw");
  const valueAway = calculateValue(bestAway, "Away");
    ...
    <div className="bg-white rounded-2xl shadow-md border border-gray-200 hover:shadow-2xl transition-all duration-300 overflow-hidden group">
      ...
      <div className="p-5 pb-4">
        <div className="flex items-center justify-between mb-6">
          ...
          <div className="text-sm font-bold text-gray-400 uppercase tracking-widest mx-4">
            VS
          </div>
